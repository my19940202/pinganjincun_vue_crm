    ...
    <div class="reply-text">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <router-link to="/reply/text/create"><button type="button" class="btn btn-info btn-create pull-right">New</button></router-link>
...
<script>
    ...
    export default {
        ...
        methods: {
            getpages() {
                this.$axios({
                    url: '/wechat-text-reply-page-info',
                    method: 'get',
                }).then((res) => {
            ...
            getlist() {
                ...
                this.$axios({
                    url: '/wechat-text-reply-index-' + this.current,
                    method: 'get',
                }).then((res) => {
            ...
            edit(id) {
                this.$router.push({ path:`/reply/text/edit/${id}`})
            },
            del(id) {
                var r=confirm("Confirm to delete?")
                if(r == true) {
                    this.$axios({
                        url: '/wechat-text-reply-destroy-'+id,
                        method: 'post'
                    }).then((res) => {
