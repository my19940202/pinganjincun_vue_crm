...
export default {
    ...
    data() {
        ...
        return {
            api: {
                list: '/om/order-list',
                total: '/om/order-page-info',
                show: '/om/order-show-',
                upate: '/om/order-update-',
                export: '/om/order-export',
                product: '/om/product-data',
                express: '/om/order-update-express-',
                // order
                state: {
                    close: '/om/order-update-close',
                    send: '/om/order-update-send',
                    complete: '/om/order-update-complete'
                }
            },
            editable: true,
            addressObjFlag: 0,
