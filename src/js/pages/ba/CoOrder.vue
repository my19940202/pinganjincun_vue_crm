...
export default {
    ...
    data() {
        ...
        return {
            api: {
                list: '/co/order-list',
                total: '/co/order-page-info',
                show: '/co/order-show-',
                upate: '/co/order-update-',
                export: '/co/order-export',
                product: '/ba/product-data',
                express: '/co/order-update-express-',
                // order
                state: {
                    close: '/co/order-update-close',
                    send: '/co/order-update-send',
                    complete: '/co/order-update-complete'
                }
            },
            editable: true,
            addressObjFlag: 0,
