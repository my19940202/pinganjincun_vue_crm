<template>
    <div class="fans">
        <div class="panel panel-default">
            <div class="panel-heading">粉丝同步</div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getpages() {
                this.$axios({
                    url: '/wechat-sync-user-page-info',
                    method: 'get',
                }).then((res) => {
            ...
            getlist() {
                ...
                this.$axios({
                    url: '/wechat-sync-user-index-' + this.current,
                    method: 'get',
                }).then((res) => {
            ...
            sync() {
                let self = this;
                var r=confirm("Confirm to Sync fans data?")
                if(r == true) {
                    this.$axios({
                        url: '/wechat-sync-user-store',
                        method: 'post',
                    }).then((res) => {
