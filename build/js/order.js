...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__orderEntry_vue__ = __webpack_require__(430);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__orderEntry_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__orderEntry_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__order_router__ = __webpack_require__(435);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#app',
    router: __WEBPACK_IMPORTED_MODULE_3__order_router__["a" /* default */],
    render: function render(h) {
        return h(__WEBPACK_IMPORTED_MODULE_2__orderEntry_vue___default.a);
    }
});
...
Component.options.__file = "src/js/h5/orderEntry.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3c25ac4e", Component.options)
  } else {
    hotAPI.reload("data-v-3c25ac4e", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("39c8df2a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/.0.28.11@css-loader/index.js!../../../node_modules/.13.7.2@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3c25ac4e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/.6.0.7@sass-loader/lib/loader.js!../../../node_modules/.13.7.2@vue-loader/lib/selector.js?type=styles&index=0!./orderEntry.vue", function() {
     var newContent = require("!!../../../node_modules/.0.28.11@css-loader/index.js!../../../node_modules/.13.7.2@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3c25ac4e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/.6.0.7@sass-loader/lib/loader.js!../../../node_modules/.13.7.2@vue-loader/lib/selector.js?type=styles&index=0!./orderEntry.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-3c25ac4e", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__orderList_vue__ = __webpack_require__(436);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__orderList_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__orderList_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__orderDetail_vue__ = __webpack_require__(441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__orderDetail_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__orderDetail_vue__);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    ...
    routes: [{
        path: '/',
        component: __WEBPACK_IMPORTED_MODULE_2__orderList_vue___default.a
    }, {
        path: '/detail',
        component: __WEBPACK_IMPORTED_MODULE_3__orderDetail_vue___default.a
    }]
}));
...
Component.options.__file = "src/js/h5/orderList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-368592f2", Component.options)
  } else {
    hotAPI.reload("data-v-368592f2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("2ca4b07c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/.0.28.11@css-loader/index.js!../../../node_modules/.13.7.2@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-368592f2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/.6.0.7@sass-loader/lib/loader.js!../../../node_modules/.13.7.2@vue-loader/lib/selector.js?type=styles&index=0!./orderList.vue", function() {
     var newContent = require("!!../../../node_modules/.0.28.11@css-loader/index.js!../../../node_modules/.13.7.2@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-368592f2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/.6.0.7@sass-loader/lib/loader.js!../../../node_modules/.13.7.2@vue-loader/lib/selector.js?type=styles&index=0!./orderList.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        reqOrderList: function reqOrderList() {
            var me = this;
            me.$axios.post(me.api.list, {}).then(function (res) {
                if (res.data.data) {
      ...
      [
        _c("div", { staticClass: "title" }, [
          _vm.orderList.length === 0
            ...
            : _vm._e(),
          _vm._v(" "),
          _vm.orderList.length > 0 ? _c("span", [_vm._v("您的订单")]) : _vm._e()
        ]),
        _vm._v(" "),
          ...
          return _c(
            ...
            [
              _c("div", { staticClass: "item-img" }, [
                _c("img", { attrs: { src: item.product_img, alt: "产品图片" } })
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "item-text" }, [
                _c("div", [
                  _vm._v("商品名称：" + _vm._s(item.product_name) + " ")
                ]),
                _vm._v(" "),
                _c("div", [
                  _vm._v("快递单号：" + _vm._s(item.express_code) + " ")
                ]),
                _vm._v(" "),
                _c("div", [
                  _vm._v("兑换时间：" + _vm._s(item.order_date) + " ")
                ]),
                _vm._v(" "),
                _c("div", [_vm._v("订单状态：" + _vm._s(item.state) + " ")])
              ])
            ]
          )
        })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-368592f2", module.exports)
  }
}
...
Component.options.__file = "src/js/h5/orderDetail.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d48f870c", Component.options)
  } else {
    hotAPI.reload("data-v-d48f870c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("3088c51d", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/.0.28.11@css-loader/index.js!../../../node_modules/.13.7.2@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d48f870c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/.6.0.7@sass-loader/lib/loader.js!../../../node_modules/.13.7.2@vue-loader/lib/selector.js?type=styles&index=0!./orderDetail.vue", function() {
     var newContent = require("!!../../../node_modules/.0.28.11@css-loader/index.js!../../../node_modules/.13.7.2@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d48f870c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/.6.0.7@sass-loader/lib/loader.js!../../../node_modules/.13.7.2@vue-loader/lib/selector.js?type=styles&index=0!./orderDetail.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
...
// module
exports.push([module.i, "\n.top-poster {\n  width: 100%;\n  height: 130px;\n  line-height: 130px;\n  text-align: center;\n  font-size: 25px;\n  color: #fff;\n  font-weight: bold;\n}\n.top-poster span {\n    border-bottom: 3px solid rgba(255, 255, 255, 0.3);\n    padding-bottom: 10px;\n}\n.middle-form {\n  width: 600px;\n  margin: 140px auto 0 auto;\n}\n.middle-form .title {\n    color: #99694b;\n    font-size: 25px;\n    padding-bottom: 25px;\n}\n.middle-form .detail {\n    width: 600px;\n    padding: 20px;\n    height: auto;\n    margin-bottom: 25px;\n    border-radius: 10px;\n    background: #f8f8f8;\n    color: #b2b2b8;\n}\n.middle-form .detail .detail-header {\n      display: -webkit-box;\n      display: -ms-flexbox;\n      display: flex;\n}\n.middle-form .detail .detail-body {\n      margin-top: 60px;\n}\n.middle-form .detail .detail-body p span {\n        padding-right: 30px;\n}\n.middle-form .detail .item-img {\n      width: 130px;\n      height: 130px;\n      -webkit-box-flex: 0;\n          -ms-flex-positive: 0;\n              flex-grow: 0;\n}\n.middle-form .detail .item-img img {\n        width: 100%;\n        height: 100%;\n}\n.middle-form .detail .item-text {\n      margin-left: 57px;\n      width: auto;\n      height: auto;\n      -webkit-box-flex: 1;\n          -ms-flex-positive: 1;\n              flex-grow: 1;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_address__ = __webpack_require__(106);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        genExpressUrl: function genExpressUrl(company) {
            var result = '';
            if (!!company) {
                if (company.indexOf('EMS') !== -1) {
                    result = __WEBPACK_IMPORTED_MODULE_0__config_address__["c" /* expressUrl */].ems;
                } else {
                    result = __WEBPACK_IMPORTED_MODULE_0__config_address__["c" /* expressUrl */].shufen;
                }
            }
            return result;
        }
    ...
    _c("div", { staticClass: "middle-form" }, [
      ...
      _c("div", { staticClass: "detail" }, [
        _c("div", { staticClass: "detail-header" }, [
          _c("div", { staticClass: "item-img" }, [
            _c("img", {
              attrs: { src: _vm.detail.product_img, alt: "产品图片" }
            })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "item-text" }, [
            _c("div", [
              _vm._v("商品名称：" + _vm._s(_vm.detail.product_name) + " ")
            ]),
            _vm._v(" "),
            _c("br"),
            _c("br"),
        ...
        _c("div", { staticClass: "detail-body" }, [
          ...
          _c("p", [
            _c("span", [_vm._v("订单状态:")]),
            _vm._v(_vm._s(_vm.detail.state))
          ]),
          _vm._v(" "),
          _c("p", [
            _c("span", [_vm._v("运 单 号:")]),
            _vm._v(" "),
            _c(
              "a",
              {
                attrs: { href: _vm.genExpressUrl(_vm.detail.express_company) }
              },
              [
                _vm._v(
                  "\n                        " +
                    _vm._s(_vm.detail.express_code) +
                    "\n                    "
                )
              ]
            )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-d48f870c", module.exports)
  }
}
